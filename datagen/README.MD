...
bash step1.2_completion.sh /data/shenzhe/Toucan/data/ToolUse_smithery_100_1tool_1761156698/ToolUse_s2q_smithery_100_1tool_1761156698_prepared.jsonl gpt-5-mini openai 1.2 false "$OPENAI_API_KEY" --batch_size 5
```
...
/data/shenzhe/Toucan/data/ToolUse_smithery_100_1tool_1761156698/processed/ToolUse_s2q_smithery_100_1tool_1761156698_gpt-5-mini_3sanitized_qced_prepared.jsonl \
gpt-5-mini \
openai \
2.2 \
false \
...
```
python step2.3_process_completion.py --input_file /data/shenzhe/Toucan/data/ToolUse_smithery_100_1tool_1761156698/processed/ToolUse_s2q_smithery_100_1tool_1761156698_gpt-5-mini_3sanitized_qced_gpt-5-mini_results.jsonl
```
...
bash step3.1_completion_agent.sh \
  /data/shenzhe/Toucan/data/ToolUse_smithery_100_1tool_1761156698/processed/quality_checked/ToolUse_s2q_smithery_100_1tool_1761156698_gpt-5-mini_3sanitized_qced_gpt-5-mini_2prepared.jsonl \
  gpt-5 \
  openai \
  3.1 \
  openai_agent \
